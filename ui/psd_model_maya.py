...
def add_interpolator(interp_graph):
    ...
    :type interp_graph: GraphTreeItem
    '''
    mc.undoInfo(openChunk=1)
...
def set_pose_type(interp_graph, pose_graph):
    ...
    pose_type_index = mc.getAttr(
        '{}.pose[{}].poseType'.format(interp_name, rig_psd.getPoseIndex(interp_name, pose_name)))
    ...
    for pose_node in sel_nodes:
        ...
        mc.setAttr('{}.pose[{}].poseType'.format(interp_name, rig_psd.getPoseIndex(interp_name, pose_name)),
                   pose_type_index)
